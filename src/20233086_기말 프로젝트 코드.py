...
class MainWindow(QMainWindow, form_class) :
    ...
    def initUI(self):
        ...
        #setFont
        QFontDatabase.addApplicationFont(os.path.join("C:/Users/smpar/OneDrive/Desktop/SSU/수업/학생회비 납부자 선별 프로그램 project/src/NanumBarunpenB.otf", "NanumBarunpenB.otf"))
    ...
    def Compare(self):
        ...
        try:
            ...
            for RowS in range(surveyMaxrow):
                ...
                if result:
                    self.surveyList[RowS][2] = 'O' 
                else:
                    self.surveyList[RowS][2] = 'X' 
